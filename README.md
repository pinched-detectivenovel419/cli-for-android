...
[![CI](https://github.com/ErikHellman/cli-for-android/actions/workflows/ci.yml/badge.svg)](https://github.com/ErikHellman/cli-for-android/actions/workflows/ci.yml)
...
```bash
curl -fsSL https://raw.githubusercontent.com/ErikHellman/cli-for-android/main/install.sh | bash
```

**Windows (PowerShell):**

```powershell
irm https://raw.githubusercontent.com/ErikHellman/cli-for-android/main/install.ps1 | iex
```
...
github_repo: "ErikHellman/cli-for-android"
```
...
```bash
git clone https://github.com/ErikHellman/cli-for-android.git
cd cli-for-android
...
```bash
go install github.com/ErikHellman/cli-for-android/cmd/acli@latest
```
...
After the workflow completes (~2 minutes), check the [Releases page](https://github.com/ErikHellman/cli-for-android/releases) and confirm:
